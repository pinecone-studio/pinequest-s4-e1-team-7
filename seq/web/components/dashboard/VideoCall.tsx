  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col items-center justify-center gap-10 px-6 py-12">
      ...
      >
        ...
        <p className="mt-2 text-sm text-zinc-400">Дохио → текст бодит цагт</p>
      </Link>
    ...
    python3 train.py       # сургаад TFJS руу export`}
        ...
        <ul className="mt-3 space-y-1 text-xs text-zinc-500">
          <li>
            Шинэ дохио:{" "}
            <code className="text-zinc-400">training/labels.txt</code> дээр нэр
            нэм
          </li>
          <li>
            train.py дуусахад загвар{" "}
            <code className="text-zinc-400">public/models/seq</code> руу
            автоматаар орно
          </li>
