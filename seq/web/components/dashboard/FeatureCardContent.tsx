  ...
  return (
    <>
      ...
      <div className="relative z-10 flex h-full flex-col justify-between p-6">
        <div>
          <h3 className="text-[26px] font-bold leading-snug" style={{ color: f.dark ? "#eaf0f8" : "var(--text)" }}>{f.title}</h3>
          <p className="mt-2 text-[15px] leading-snug" style={{ color: f.dark ? "rgba(234,240,248,0.68)" : "var(--text-3)" }}>{f.sub}</p>
        </div>
