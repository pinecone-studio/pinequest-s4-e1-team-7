...
export const TopNav = () => {
  ...
  return (
    <header className="sticky top-0 z-40 hidden items-center justify-between gap-3 px-4 py-2 md:flex md:px-6"
      style={{ background: "var(--surface)", borderBottom: "1px solid var(--border-c)", backdropFilter: "blur(12px)" }}>
      <div className="flex min-w-0 flex-1 items-center gap-4">
        <Link href="/dashboard" className="shrink-0" aria-label="Нүүр хуудас">
          <img src="/images/logo.png" alt="Sign Bridge" className="size-10 rounded-xl object-cover" />
        </Link>
