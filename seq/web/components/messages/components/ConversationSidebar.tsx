...
export function ConversationSidebar({
  ...
  return (
    ...
    >
      <div className="px-2 pt-4 md:pt-5">
        <h1
          className="mb-4 pl-10 text-[22px] font-extrabold tracking-tight hidden md:block"
          style={{ color: "var(--text)" }}
        >
          Чат
        </h1>

        <div className="-mx-2 border-t px-2 pb-3 pt-3" style={{ borderColor: "var(--border-c)" }}>
          <div
