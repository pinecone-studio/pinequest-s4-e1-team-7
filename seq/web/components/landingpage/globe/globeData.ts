...
export const GLOBE_ITEMS = [
  ...
  },
  {
    ...
    stats: [
      { label: "Ажлын байрны харилцааны бэрхшээлийг бууруулах", value: "+90%" },
      { label: "Дохионы хэлний хэрэглэгчдэд хүртээмжтэй", value: "25,000+" },
      { label: "Бодит цагийн AI хөрвүүлэх нарийвчлал", value: "98%" },
