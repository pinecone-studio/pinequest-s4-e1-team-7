...
const DATA = {
  before: {
    accent: "#ef4444",
    tag: "SignBridge-гүйгээр",
    desc: "Сонсголын бэрхшээлтэй иргэд нийгэмд оролцох, ажил олох боломж хязгаарлагдмал байдаг.",
    big: { label: "Ажилгүй иргэд", value: "2,400+" },
    mid: { label: "Сонсголын бэрхшээлтэй", value: "25,000+" },
    grid: [{ label: "Хандалтын хязгаарлалт", value: "90%" }, { label: "Тусламж авах боломж", value: "Бага" }],
  },
  after: {
    accent: "#f5c518",
    tag: "SignBridge-тэй",
    desc: "Иргэд бодит цагт харилцаж, нийгэмд бүрэн оролцох, ажилд орох боломжтой болно.",
    big: { label: "Ажилгүйдэл буурах", value: "−90%" },
    mid: { label: "Нийгэмд нэгдэх иргэд", value: "25,000+" },
