  ...
  return (
    <>
      ...
      <section style={{ background: "var(--bg)" }} className="w-full py-24 px-8 md:px-16">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-16 items-center feature-video-flex" style={{ display: "flex", flexDirection: "row", gap: "clamp(24px, 5vw, 48px)", alignItems: "center" }}>
          ...
          <div className="flex-1 flex justify-center">
            <div className="lphone" style={{ width: "clamp(160px, 30vw, 300px)" }}>
              ...
              <div style={{ padding: "clamp(10px, 2vw, 12px)", display: "flex", flexDirection: "column", gap: "clamp(6px, 1.5vw, 8px)" }}>
                <div style={{ display: "flex", gap: "clamp(6px, 1.5vw, 8px)", justifyContent: "center" }}>
                  <button style={{ width: "clamp(40px, 8vw, 44px)", height: "clamp(40px, 8vw, 44px)", borderRadius: "50%", background: "#d06a4f", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <svg width="clamp(16px, 3vw, 18px)" height="clamp(16px, 3vw, 18px)" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2">
                  ...
                  <button style={{ width: "clamp(40px, 8vw, 44px)", height: "clamp(40px, 8vw, 44px)", borderRadius: "50%", background: "var(--olive)", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <svg width="clamp(16px, 3vw, 18px)" height="clamp(16px, 3vw, 18px)" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2">
          ...
          <div className="flex-1">
            <div className="ltag" style={{ fontSize: "clamp(11px, 2vw, 13px)" }}>03</div>
