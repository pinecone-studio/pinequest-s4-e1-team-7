...
export const FeaturesLeftPanel = ({ p }: { p: MotionValue<number> }) => {
  ...
  const col0 = useTransform(op0, [0.22, 1], ["rgba(255,255,255,0.28)", "#f5c518"]);
  const col1 = useTransform(op1, [0.22, 1], ["rgba(255,255,255,0.28)", "#f5c518"]);
  const col2 = useTransform(op2, [0.22, 1], ["rgba(255,255,255,0.28)", "#f5c518"]);
