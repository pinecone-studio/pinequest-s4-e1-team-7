export const FeatureVoiceToText = () => {
  return (
    <>
      ...
      >
        <div
          className="max-w-5xl mx-auto flex flex-col md:flex-row-reverse gap-16 items-center feature-voice-flex"
          style={{
            display: "flex",
        ...
        >
          ...
          <div className="flex-1">
            ...
            >
              Яриаг бичвэр болгож харуулдаг тул дохионы хэлтнүүд бусдын яриаг
              бичгээр уншиж ойлгоно. Энэ нь хурдан бөгөөд алдаагүй ажилладаг.
            </p>
          </div>
        </div>
      </section>
